...
with open("10_90 txt/sr.txt", 'r', encoding='utf-8') as f:
    ...
    axs[0, 0].plot(density_list_Sr, ECN_Sr, 'o-', label=r'Sr-O: Sn$_{62}$Sr$_{7}$O$_{69}$', color='cornflowerblue', markersize=6)
    axs[1, 0].plot(density_list_Sr, ECN_time_Sr, 'o-', label=r'Sr-O: Sn$_{62}$Sr$_{7}$O$_{69}$', color='cornflowerblue', markersize=6)
    axs[0, 1].plot(density_list_Sr, L_ave_Sr, 'o-', label=r'Sr-O: Sn$_{62}$Sr$_{7}$O$_{69}$', color='cornflowerblue', markersize=6)
    axs[1, 1].plot(density_list_Sr, L_ave_time_Sr, 'o-', label=r'Sr-O: Sn$_{62}$Sr$_{7}$O$_{69}$', color='cornflowerblue', markersize=6)
    axs[0, 2].plot(density_list_Sr, Distortion_Sr, 'o-', label=r'Sr-O: Sn$_{62}$Sr$_{7}$O$_{69}$', color='cornflowerblue', markersize=6)
    axs[1, 2].plot(density_list_Sr, Distortion_time_Sr, 'o-', label=r'Sr-O: Sn$_{62}$Sr$_{7}$O$_{69}$', color='cornflowerblue', markersize=6)
...
with open('30_70 txt/' + file_name, 'r', encoding='utf-8') as f:
    ...
    axs[0, 0].plot(density_list_Sn, ECN_Sn, 'o-', label=r'Sn-O: Sn$_{48}$Sr$_{21}$O$_{69}$', color='red', markersize=6)
    axs[1, 0].plot(density_list_Sn, ECN_time_Sn, 'o-', label=r'Sn-O: Sn$_{48}$Sr$_{21}$O$_{69}$', color='red', markersize=6)
    axs[0, 1].plot(density_list_Sn, L_ave_Sn, 'o-', label=r'Sn-O: Sn$_{48}$Sr$_{21}$O$_{69}$', color='red', markersize=6)
    axs[1, 1].plot(density_list_Sn, L_ave_time_Sn, 'o-', label=r'Sn-O: Sn$_{48}$Sr$_{21}$O$_{69}$', color='red', markersize=6)
    axs[0, 2].plot(density_list_Sn, Distortion_Sn, 'o-', label=r'Sn-O: Sn$_{48}$Sr$_{21}$O$_{69}$', color='red', markersize=6)
    axs[1, 2].plot(density_list_Sn, Distortion_time_Sn, 'o-', label=r'Sn-O: Sn$_{48}$Sr$_{21}$O$_{69}$', color='red', markersize=6)
...
with open("30_70 txt/sr.txt", 'r', encoding='utf-8') as f:
    ...
    axs[0, 0].plot(density_list_Sr, ECN_Sr, 'o-', label=r'Sr-O: Sn$_{48}$Sr$_{21}$O$_{69}$', color='blue', markersize=6)
    axs[1, 0].plot(density_list_Sr, ECN_time_Sr, 'o-', label=r'Sr-O: Sn$_{48}$Sr$_{21}$O$_{69}$', color='blue', markersize=6)
    axs[0, 1].plot(density_list_Sr, L_ave_Sr, 'o-', label=r'Sr-O: Sn$_{48}$Sr$_{21}$O$_{69}$', color='blue', markersize=6)
    axs[1, 1].plot(density_list_Sr, L_ave_time_Sr, 'o-', label=r'Sr-O: Sn$_{48}$Sr$_{21}$O$_{69}$', color='blue', markersize=6)
    axs[0, 2].plot(density_list_Sr, Distortion_Sr, 'o-', label=r'Sr-O: Sn$_{48}$Sr$_{21}$O$_{69}$', color='blue', markersize=6)
    axs[1, 2].plot(density_list_Sr, Distortion_time_Sr, 'o-', label=r'Sr-O: Sn$_{48}$Sr$_{21}$O$_{69}$', color='blue', markersize=6)
