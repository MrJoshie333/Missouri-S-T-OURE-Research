...
LOCAL_BASE="/mnt/c/Users/joshu/PycharmProjects/S&T OURE Research/SrSnO/Void/10-90" # Or any path on your local machine
...
for dens in "${DENSITIES[@]}"; do
  for run in {1..9}; do
    ...
    REMOTE_FILE="$REMOTE_BASE/$dens/run$run/_quench_200_eq_300/_voids/volumes.txt"
