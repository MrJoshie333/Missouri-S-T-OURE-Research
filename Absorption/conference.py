...
# fig.suptitle('Absorption of Amorphous Compounds', fontsize=32)
...
# axs[0].plot(energy, absorption, label='SrSnO 4.25', marker="s", color="black", linewidth=2)
axs[1].plot(energy, absorption, label=r'$\mathrm{SrSnO, 4.25 \, g/cm}^3$', marker="|", color="black", linewidth=2)
axs[0].set_ylabel(r'Absorption (cm$^{-1})$', fontsize=18)
...
# fig.tight_layout()
fig.subplots_adjust(left=0.25, bottom=0.25, right=0.75, top=0.75, wspace=0, hspace=0)
