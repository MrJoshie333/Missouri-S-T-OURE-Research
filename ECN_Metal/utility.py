...
def filenameToLatex(filename: str, split_index: int = 1) -> str:
    # Extract the last directory or filename (ignoring extensions if present)
    compound_name = filename.split('/')[split_index - 1]  # For Unix-like systems or cross-platform
