...
while i < 4:
    ...
    axs[i, j].set_yticks(np.arange(0, 0.1, 0.02))
...
axs[0, 1].legend(loc='right', title=r'Density (g/$\mathrm{cm}^3$)', bbox_to_anchor=(2.5, 0.5), prop={"size": 12},
                 ncols=2)
axs[1, 1].legend(loc='right', bbox_to_anchor=(2.58, 0.5), prop={"size": 12}, ncols=2)
axs[2, 1].legend(loc='right', bbox_to_anchor=(2.5, 0.5), prop={"size": 12}, ncols=2)
axs[3, 1].legend(loc='right', bbox_to_anchor=(2.25, 0.5), prop={"size": 12}, ncols=2)

axs[0, 0].text(138, 0.08, r'$\mathrm{SnO_2}$', fontsize=16)
axs[1, 0].text(128, 0.08, r'$\mathrm{Ta_2O_5}$', fontsize=16)
axs[2, 0].text(138, 0.08, r'$\mathrm{SnO}$', fontsize=16)
axs[3, 0].text(138, 0.08, r'$\mathrm{SnO}$', fontsize=16)
